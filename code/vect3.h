...
public:
	...
	Vect3()
	{
	}//never put anything in here! too slow
	...
	const Vect3 &operator= (const Vect3& t) 
	{
		v[0] = t.v[0];
		v[1] = t.v[1];
		v[2] = t.v[2]; 
	...
	float operator^ (const Vect3& t) const 
	{
	...
	void Interp(const Vect3 &v1,const Vect3 &v2,float t) 
	{
		*this = v1;
		*this -= v2;
		*this *= t;
...
/*	bool operator == (const Vect3& t) const 
	{
		return v[0] == t.v[0] &&
				v[1] == t.v[1] &&
				v[2] == t.v[2];
...
*/
	...
	inline Vect3 operator +(const Vect3 &rhs) const 
	{ 
		return Vect3(v[0] + rhs.v[0], v[1] + rhs.v[1], v[2] + rhs.v[2]); 
	}
	...
	inline Vect3 operator *(const float scalar) const 
	{ 
		return Vect3(v[0] * scalar, v[1] * scalar, v[2] * scalar); 
	}
